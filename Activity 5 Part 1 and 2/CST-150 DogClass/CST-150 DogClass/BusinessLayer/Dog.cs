...
namespace CST_150_DogClass.BusinessLayer
{
    internal class Dog
    {
        ...
        public double CalCircumference()
        {
            ...
            // Since NeckRad is at the class level we can 
            // use this property inside this method. 
            // Conversion from radius to circumference (2*Pi*r)
            circumference = 2 * Math.PI * NeckRad;
            // Then convert to centimeters from inches
        ...
        public double CalWeight()
        {
            ...
            // Convert the property Weight from pounds to 
            // kilograms
